package com.mycompany.challengeoneconversor.servicios;
...
public class ServicioConversor {
    ...
    // validamos el ingreso de solo numeros y 1 punto
    // recibimos el evento y el textfield para hacer la validacion
    ...
    // formatenado los doubles a solo 3 decimales
    ...
    public String calcularCambio(int opcion, Double cantidad) {
        ...
        switch (opcion) {
            case 0:
                // cambio de peso chileno a dolar
                resultado = formatearDecimales(ObtenerTasaCambio(origen = "clp", destino = "usd") * cantidad, 4)
                        .toString() + " Usd";
                break;
            case 1:
                // cambio de pesos chilenos a euros
                resultado = formatearDecimales(ObtenerTasaCambio(origen = "clp", destino = "eur") * cantidad, 4)
                        .toString() + " Euros";
                break;
            case 2:
                // cambio de pesos chilenos a libras esterlinas
                resultado = formatearDecimales(ObtenerTasaCambio(origen = "clp", destino = "gbp") * cantidad, 4)
                        .toString() + " Libras";
                break;
            case 3:
                // cambio de pesos chilenos a yen japones
                resultado = formatearDecimales(ObtenerTasaCambio(origen = "clp", destino = "jpy") * cantidad, 4)
                        .toString() + " Yen";

                break;
            case 4:
                // cambio de pesos chilenos a won sur-coreano
                resultado = formatearDecimales(ObtenerTasaCambio(origen = "clp", destino = "krw") * cantidad, 4)
                        .toString() + " Won";

                break;
            case 6:
                // cambio de dolares a pesos chilenos
                resultado = formatearDecimales(ObtenerTasaCambio(origen = "usd", destino = "clp") * cantidad, 4)
                        .toString() + " Clp";

                break;
            case 7:
                // cambio de euros a pesos chilenos
                resultado = formatearDecimales(ObtenerTasaCambio(origen = "eur", destino = "clp") * cantidad, 4)
                        .toString() + " Clp";

                break;
            case 8:
                // cambio de libras a pesos chilenos
                resultado = formatearDecimales(ObtenerTasaCambio(origen = "gbp", destino = "clp") * cantidad, 4)
                        .toString() + " Clp";

                break;
            case 9:
                // cambio de yen a pesos chilenos
                resultado = formatearDecimales(ObtenerTasaCambio(origen = "jpy", destino = "clp") * cantidad, 4)
                        .toString() + " Clp";

                break;
            case 10:
                // cambio de won surcoreano a pesos chilenos
                resultado = formatearDecimales(ObtenerTasaCambio(origen = "krw", destino = "clp") * cantidad, 4)
                        .toString() + " Clp";
